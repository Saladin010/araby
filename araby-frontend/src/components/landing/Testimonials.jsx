    ...
    const testimonials = [
        {
            ...
            text: 'تحسن مستواي في اللغة الإنجليزية بشكل ملحوظ مع Mr. Ahmed. الشرح واضح والمتابعة مستمرة. أنصح الجميع بالانضمام.',
            rating: 5,
        },
        {
            name: 'فاطمة أحمد',
            grade: 'الصف الأول الثانوي',
            text: 'أسلوب تدريس رائع وسهل الاستخدام. Mr. Ahmed متمكن جداً من اللغة الإنجليزية ويشرح بطريقة مبسطة. حصلت على درجات ممتازة في الامتحانات.',
            rating: 5,
        },
        {
            name: 'محمود حسن',
            grade: 'الصف الثاني الإعدادي',
            text: 'أفضل معلم لغة إنجليزية. يهتم بكل طالب ويتابع تقدمه في القواعد والمحادثة باستمرار. النظام الإلكتروني يسهل حجز الحصص والمتابعة.',
            rating: 5,
        },
        {
            name: 'سارة علي',
            grade: 'الصف الثالث الإعدادي',
            text: 'تجربة تعليمية مميزة في تعلم اللغة الإنجليزية. الدروس منظمة والمحتوى شامل. أصبحت أحب الإنجليزي بفضل طريقة شرح Mr. Ahmed الرائعة.',
            rating: 5,
        },
    ]
