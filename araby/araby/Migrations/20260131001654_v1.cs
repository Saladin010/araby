        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Grades_AspNetUsers_RecordedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentPayments_AspNetUsers_RecordedBy",
                        column: x => x.RecordedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentPayments_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentPayments_FeeTypes_FeeTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeeTypeGroups", x => new { x.FeeTypeId, x.StudentGroupId });
                    table.ForeignKey(
                        name: "FK_FeeTypeGroups_FeeTypes_FeeTypeId",
                        column: x => x.FeeTypeId,
                        principalTable: "FeeTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FeeTypeGroups_StudentGroups_StudentGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentGroupMembers", x => new { x.StudentGroupId, x.StudentId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeeTypeGroups_StudentGroupId",
                table: "FeeTypeGroups",
                column: "StudentGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_Grades_RecordedBy",
                table: "Grades",
                column: "RecordedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentPayments_FeeTypeId",
                table: "StudentPayments",
                column: "FeeTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentPayments_RecordedBy",
                table: "StudentPayments",
                column: "RecordedBy");
